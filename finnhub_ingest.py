...
from models import Article # Calls a custom class for the correct organization of data for storage and financial analysis
...
# Shows example articles from a successful multi-ticker scrape
